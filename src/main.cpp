...
// Copyright (c) 2011-2013 livecoin Developers.
...
uint256 hashGenesisBlock("0x4e47482830b8bbb031cd513a2c89228c821a1beae2ce4c885ff6a17acd2a965e");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // livecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "livecoin Signed Message:\n";
...
// Livecoin difficulty adjustment protocol switch
   ...
   int64 nInterval = fInflationFixProtocol? (nTargetTimespanCurrent / nTargetSpacing) : (nTargetTimespanCurrent / (nTargetSpacing / 2));
    ...
    // livecoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal livecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "livecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x3b2ce3faf4d47b51804678a1d8fc8b0f84a641ce7e0160179276f6fdfa495276");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Livecoin, A Currency with a real marketing purpose that even mom and pop can use";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1388856093;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 104039;

        if (fTestNet)
        {
            block.nTime    = 1388496455;             //test is supported
            block.nNonce   = 2619024;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x772e9dc44dd47be614257d1119566ae4f9fec6f70189056772525d1e7bfa998e"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // livecoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // livecoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
